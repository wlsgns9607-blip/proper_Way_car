export default function handler(req, res) {
  try {
    ...
    const host = (req.headers && req.headers['x-forwarded-host']) ? req.headers['x-forwarded-host'] : ((req.headers && req.headers.host) ? req.headers.host : 'properwaycar.vercel.app');
